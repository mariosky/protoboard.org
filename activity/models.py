...
class LearningStyleInventory(models.Model):
    ...
    visual = models.PositiveSmallIntegerField(null=True)
    verbal = models.PositiveSmallIntegerField(null=True)
    aural = models.PositiveSmallIntegerField(null=True)
    physical = models.PositiveSmallIntegerField(null=True)
    logical = models.PositiveSmallIntegerField(null=True)
    social = models.PositiveSmallIntegerField(null=True)
    solitary = models.PositiveSmallIntegerField(null=True)
