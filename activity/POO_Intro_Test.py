...
from activity.models import LearningActivity,UserProfile,LearningStyleInventory, \
     LearningActivity, UserLearningActivity,ActivityTree
from django.contrib.auth.models import User
from activity.interaction_handler import SimpleSequencing
...
j = User.objects.create_user('john', 'lennon@thebeatles.com', '1234')
j.is_active = True
j.save()
